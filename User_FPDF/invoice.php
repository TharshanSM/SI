...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "DELIVERY METHOD", 0, 0, "C");
...
function addReference($ref)
{
	...
	$y2  = $y1+5;
	$this->SetXY( $r1 , $y1 );
	$this->Cell($length,4, "CLIENT REFERENCE : SI000" . $ref);
}
